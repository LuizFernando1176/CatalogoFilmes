                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control" type="text" name="temporada_ep" placeholder="Ex:T01EP01">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group row">
                                    ...
                                    </div><button type="button"  name="ator" title="Adicionar Ator/Atriz" class="btn btn-primary btn-rounded btn-icon" data-toggle="modal" data-target="#modalExemplo">
                                                    <i class="ti-plus"></i>
                                                </button>    
